...
impl DeltaDense {
    ...
    fn locate(&self, id: u32) -> (usize, u64) {
        let block_seek = as_slice_ref::<u32>(&self.crdxf0)[id as usize / 64] as usize;
        let rem = id % 64;
